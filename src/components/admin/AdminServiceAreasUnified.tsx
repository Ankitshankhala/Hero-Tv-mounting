...
export const AdminServiceAreasUnified = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      {/* Comprehensive ZIP Data Management */}
      <Card className="bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-primary">
            <Activity className="h-5 w-5" />
            Comprehensive ZIP Data System
          </CardTitle>
          <CardDescription>
            Enhanced performance system for ZIP code validation and service coverage
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <OptimizedZipDataManager />
            <PerformanceOptimizationSwitch />
          </div>
        </CardContent>
      </Card>
