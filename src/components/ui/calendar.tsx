...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 pointer-events-auto bg-white rounded-lg shadow-lg", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal text-slate-900 hover:bg-slate-100 hover:text-slate-900 aria-selected:opacity-100"
        ),
