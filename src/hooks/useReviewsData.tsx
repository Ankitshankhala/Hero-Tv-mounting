...
let globalAdminPanelReviews: AdminReview[] = [
  {
    ...
    comment: 'Amazing service! They mounted our 75" TV perfectly and hid all the cables. The technician was professional and cleaned up after himself. Highly recommend!',
    status: 'approved',
    hasImages: true,
    date: '2024-01-15',
    worker: 'Alex Thompson',
    imageUrl: '/lovable-uploads/9b4cf239-a12b-4275-9ca2-a4abafb59c40.png'
  },
  {
    id: 'REV002',
    customer: 'Mike R.',
    ...
    comment: 'Hero TV Mounting saved my living room! What used to be a mess of cables is now a clean, modern entertainment space. The full motion mount is perfect for our sectional.',
    status: 'approved',
    hasImages: true,
    date: '2024-01-14',
    worker: 'Maria Garcia',
    imageUrl: '/lovable-uploads/77f65da7-38bc-4d01-afdd-bb998049c77b.png'
  },
  {
    id: 'REV003',
    customer: 'Jennifer L.',
    ...
    comment: 'Professional installation and fair pricing. They even moved our outlet behind the TV so there are zero visible wires. The attention to detail was impressive.',
    status: 'approved',
    hasImages: true,
    date: '2024-01-13',
    worker: 'David Lee',
    imageUrl: '/lovable-uploads/4a49b814-b16a-4daf-aa91-3a52fcbb5fae.png'
  },
  {
    id: 'REV004',
    customer: 'David K.',
    ...
    comment: 'The team arrived on time and completed the installation quickly. Our 65" TV looks amazing on the wall and the cable management is flawless. Will definitely use them again!',
    status: 'approved',
    hasImages: true,
    date: '2024-01-12',
    worker: 'Sarah Wilson',
    imageUrl: '/lovable-uploads/6889f051-f5b1-4f2a-a093-a09693378bd4.png'
  },
  {
    id: 'REV005',
    customer: 'Lisa P.',
    ...
    comment: 'Excellent customer service from start to finish. They explained everything clearly and the final result exceeded our expectations. The TV mounting looks professional and secure.',
    status: 'approved',
    hasImages: true,
    date: '2024-01-11',
    worker: 'Michael Brown',
    imageUrl: '/lovable-uploads/cf56b4f9-cc16-4662-ba09-6186268ae1a0.png'
  }
];
