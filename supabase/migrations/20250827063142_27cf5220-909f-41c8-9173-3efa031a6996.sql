-- Drop and recreate the find_available_workers_polygon function with correct day_of_week casing
DROP FUNCTION IF EXISTS public.find_available_workers_polygon(text, date, time without time zone, integer);
...
BEGIN
  -- Get the day name for the booking date with proper casing (Sunday, Monday, etc.)
