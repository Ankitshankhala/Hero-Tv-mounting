...
-- 1) Create trigger function to call the booking-notification-watchdog Edge Function
...
BEGIN
  ...
  -- The Edge Function will handle a short grace delay and per-recipient checks.
...
-- 2) Ensure we only have a single clean trigger on INSERT for bookings
