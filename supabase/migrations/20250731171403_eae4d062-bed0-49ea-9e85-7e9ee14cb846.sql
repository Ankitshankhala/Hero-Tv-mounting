-- Clean Database Migration - Phase 2 Revised (Fixed)
...
-- Step 3: First remove the default to avoid casting issues
ALTER TABLE public.bookings ALTER COLUMN status DROP DEFAULT;

-- Step 4: Clean up and recreate booking_status enum with proper values
...
-- Step 5: Create validation function for booking/payment status consistency
...
-- Step 6: Create trigger for booking/payment status consistency
...
-- Step 7: Update payment authorization trigger for new workflow
