-- Clean Database Migration - Phase 2 Revised (Fixed with Policies)
...
-- Step 3: Drop policies that depend on the status column
...
-- Step 4: Remove the default to avoid casting issues
ALTER TABLE public.bookings ALTER COLUMN status DROP DEFAULT;

-- Step 5: Clean up and recreate booking_status enum with proper values
...
-- Step 6: Recreate the policies with the new enum
...
-- Step 7: Create validation function for booking/payment status consistency
...
-- Step 8: Create trigger for booking/payment status consistency
...
-- Step 9: Update payment authorization trigger for new workflow
...
-- Step 10: Log successful migration
