-- Update get_available_time_slots to use proper worker service area ZIP matching
...
BEGIN
  ...
  LOOP
    ...
    -- Find workers available for this time slot using STRICT ZIP CODE MATCHING
