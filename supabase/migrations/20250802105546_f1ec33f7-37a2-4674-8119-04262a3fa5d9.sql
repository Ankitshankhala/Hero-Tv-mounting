-- Fix pg_net schema issues by updating database functions to use direct edge function calls

-- Drop existing functions and triggers
DROP TRIGGER IF EXISTS trigger_send_worker_assignment_notification ON bookings;
DROP TRIGGER IF EXISTS trigger_send_customer_booking_confirmation ON bookings;
DROP FUNCTION IF EXISTS send_worker_assignment_notification();
DROP FUNCTION IF EXISTS send_customer_booking_confirmation();

-- Create improved worker assignment notification function
...
-- Create improved customer booking confirmation function
