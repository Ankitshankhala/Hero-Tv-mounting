-- Fix the find_available_workers function to use correct column names
      ...
      WHERE 
        ...
        (
          (b.scheduled_start <= p_scheduled_start AND 
           b.scheduled_start + INTERVAL '1 hour' > p_scheduled_start) -- Fixed: removed total_duration_minutes
          OR
          (b.scheduled_start >= p_scheduled_start AND 
...
-- Now manually trigger auto-assignment for existing confirmed bookings without workers
DO $$
DECLARE
