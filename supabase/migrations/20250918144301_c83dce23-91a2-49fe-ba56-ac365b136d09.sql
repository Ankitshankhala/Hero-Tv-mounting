-- Fix geometry type - use ST_Multi to convert Polygon to MultiPolygon for us_zcta_polygons
INSERT INTO us_zcta_polygons (zcta5ce, geom, land_area, water_area) VALUES
('75001', ST_Multi(ST_GeomFromGeoJSON('{"type": "Polygon", "coordinates": [[[-96.7, 32.9], [-96.6, 32.9], [-96.6, 33.0], [-96.7, 33.0], [-96.7, 32.9]]]}')::geometry), 25000000, 500000),
('75002', ST_Multi(ST_GeomFromGeoJSON('{"type": "Polygon", "coordinates": [[[-96.6, 32.9], [-96.5, 32.9], [-96.5, 33.0], [-96.6, 33.0], [-96.6, 32.9]]]}')::geometry), 26000000, 400000),
('75003', ST_Multi(ST_GeomFromGeoJSON('{"type": "Polygon", "coordinates": [[[-96.5, 32.9], [-96.4, 32.9], [-96.4, 33.0], [-96.5, 33.0], [-96.5, 32.9]]]}')::geometry), 24000000, 600000),
('75201', ST_Multi(ST_GeomFromGeoJSON('{"type": "Polygon", "coordinates": [[[-96.8, 32.8], [-96.7, 32.8], [-96.7, 32.9], [-96.8, 32.9], [-96.8, 32.8]]]}')::geometry), 20000000, 800000),
('75202', ST_Multi(ST_GeomFromGeoJSON('{"type": "Polygon", "coordinates": [[[-96.7, 32.8], [-96.6, 32.8], [-96.6, 32.9], [-96.7, 32.9], [-96.7, 32.8]]]}')::geometry), 22000000, 700000);
