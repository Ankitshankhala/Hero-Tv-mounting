-- Temporarily disable the validation trigger to fix existing data
DROP TRIGGER IF EXISTS validate_booking_payment_consistency_trigger ON public.bookings;

-- Update the problematic booking manually
...
-- Update the validation function to be more flexible during status transitions
...
VALUES ('5268e89f-ed75-4812-bcee-550e92fda2a3', 'system', 'Booking payment status corrected manually - payment_pending -> payment_authorized', 'sent', NULL);